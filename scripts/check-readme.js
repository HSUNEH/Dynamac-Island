...
const requiredSnippets = [
  ...
  ["Now Playing expanded mode", "expanded mode shows the cover on the left, title, artist/source, smoothly advancing play time/progress, and previous/play-pause/next vector controls"],
