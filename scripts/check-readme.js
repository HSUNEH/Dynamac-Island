...
const requiredSnippets = [
  ...
  ["Activity Router Mac Context priority", "Mac Context"],
  ...
  ["Mac Context HUD section", "Experimental Mac Context HUD"],
  ["Mac Context HUD implementation", "read-only `Mac Context` status item with active app"],
  ["Mac Context permission diagnostics", "Accessibility/Screen Recording permission diagnostics"],
  ["Mac Context degradation", "user-visible `degradationState`"],
  ["Mac Context docs", "docs/macos-mcp-context-hud.md"],
